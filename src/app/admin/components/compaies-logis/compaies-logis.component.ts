...
@Component({
  selector: 'app-compaies-logis',
  templateUrl: './compaies-logis.component.html',
  styleUrls: ['./compaies-logis.component.scss']
})
export class CompaiesLogisComponent implements OnInit {

  private entidad: string = Entities.companieslogis;
  ...
  private loadData(params?: Object) {
    return new Promise(async (resolve, reject) => {
      try {
        let resp: ApiResponse = await this.api.get(Entities.companieslogis, null, this._currentPage, this._ItemsPerPage, params).toPromise();
  ...
  public delete(item) {
    this._confirmMessage = "¿Desea eliminar la sucursal " + item.name ;
    this._showConfirm = true;
    this._EntityToDelete = item;
  }
