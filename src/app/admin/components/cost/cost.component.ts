...
export class CostComponent implements OnInit {
  ...
  private loadData(params?: Object) {
    return new Promise(async (resolve, reject) => {
      try {
        let resp: ApiResponse = await this.api.get(Entities.cost, null, this._currentPage, this._ItemsPerPage, params).toPromise();
  ...
  public delete(Entity: ICost) {
    this._confirmMessage = "¿Desea eliminar el rango de costo " + Entity.rangoInferior + " y " + Entity.rangoSuperior + "?";
