...
export class MembershipComponent implements OnInit {
	...
	public _EntityToDelete: IMembership;
	...
	private loadData(params?: Object){
		return new Promise(async (resolve, reject) => {
			try {
				let resp: ApiResponse = await this.api.get(Entities.packageslist, null, this._currentPage, this._ItemsPerPage, params).toPromise();
	...
	public delete(Entity: IMembership) {
		this._confirmMessage = "¿Desea eliminar el registro de la competencia " + Entity.label + "?";
